...
import br.com.softbit.brewer.service.CadastroEstiloService;
...
public class EstilosController {
	...
	public ModelAndView pesquisar(EstiloFilter estiloFilter, BindingResult result, @PageableDefault(size=2) Pageable pageable,
		...
		PageWrapper<Estilo> pageWrapper = new PageWrapper<>(estilosRepository.filtrar(estiloFilter, pageable), httpServletRequest);
